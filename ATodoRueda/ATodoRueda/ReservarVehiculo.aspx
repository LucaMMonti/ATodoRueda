...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="lblMensajeError" runat="server" CssClass="alert alert-danger" Visible="false"></asp:Label>
        ...
        <asp:TextBox ID="txtFechaInicio" runat="server" CssClass="form-control" placeholder="Fecha inicio" TextMode="Date"></asp:TextBox>
        <asp:TextBox ID="txtFechaFin" runat="server" CssClass="form-control" placeholder="Fecha fin" TextMode="Date"></asp:TextBox>
